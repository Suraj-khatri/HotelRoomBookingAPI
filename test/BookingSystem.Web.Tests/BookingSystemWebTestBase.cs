...
{
    public abstract class BookingSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BookingSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BookingSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BookingSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BookingSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BookingSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BookingSystemDbContext, Task<T>> func)
        {
            T result;
